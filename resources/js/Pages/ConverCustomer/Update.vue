...
// 選択データを削除する処理
const updateConverCustomer = async () => {
  try {
    if (!id.value) {
    ...
    //削除
    const response = await axios.put('/api/convercustomer/update', { id: id.value });
  ...
  <div class="modal_inner s">
    ...
    <div class="signup_form">
      ...
      <div class="btn_space_modal">
        ...
        <div class="submit_btn_yes id_btn_yes" @click.prevent="updateConverCustomer">削除</div>
      </div>          
  </div>
</div>  
</template>
