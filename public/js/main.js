...
(function() {
   ...
   */
  let selectHeader = document.querySelector('#header'); // '#header'要素を選択
  if (selectHeader) {
    ...
    window.addEventListener('load', headerScrolled); // ページロード時に呼び出し
    window.addEventListener('scroll', headerScrolled); // スクロール時に呼び出し
  }
